...
declare class SourceTree {
	 ...
	 */
	wrap(tsNode: Parser.SyntaxNode | null, parent?: SourceNode | null, fieldName?: string | null): SourceNode | null;
	/**
...
declare class SourceNode {
	 ...
	 */
	constructor(tree: SourceTree, tsNode: Parser.SyntaxNode);
	/** @returns {boolean} */
	get isNamed(): boolean;
	/** @returns {boolean} */
	get isValid(): boolean;
 ...
 */
export declare class UppHelpersC extends UppHelpersBase {
