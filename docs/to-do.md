...
5. Update structural matching to permit disambiguation of `$type $name`, `$type $name;`, `$type $name = $initializer;`, `$type $name, $name2, ...;`, etc. This should involve checking concrete syntax.